            ...
            <div class="card-body">
                <form @submit.prevent="sendNotification">
                    ...
                    <div class="row">
                        <div class="mb-3 col-12">
                            ...
                            <div class="d-flex gap-3 flex-wrap">
                                ...
                                <div class="form-check mt-1">
                                    <input class="form-check-input" type="radio" name="sendTo" id="passed" value="passed" v-model="form.to_type" />
                                    <label class="form-check-label" for="passed"> {{ __('Passed users') }} </label>
                                </div>
                                <div class="form-check mt-1">
                                    <input class="form-check-input" type="radio" name="sendTo" id="unpassed" value="unpassed" v-model="form.to_type" />
                    ...
                    <div>
                        ...
                        <Link :href="route('admin.courses.show', course.id)" as="button" type="reset" class="btn btn-label-secondary me-2">{{ __('Cancel') }}</Link>
                    </div>
                </form>
            </div>
        </div>
