                        ...
                        <form @submit.prevent="form.post(route('admin.courses.store'))">
                            ...
                            <div class="row">
                                <div class="mb-3 col-12 col-sm-6">
                                    ...
                                    <select class="form-control m-select2-no" id="type_id" v-model="form.type_id">
                                        <option value="">{{ __('Choose') }}</option>
                                        <option v-for="(type, k) in types" :key="k" :value="type.id">{{ __(type.name) }}</option>
                                    </select>
                                    <p class="fs-6 text-danger" v-if="form.errors.type_id">{{ form.errors.type_id }}</p>
                                </div>
                                <div class="mb-3 col-12 col-sm-6">
                            ...
                            <div class="row">
                                <div class="mb-3 col-12 col-sm-6">
                                    ...
                                    <select class="form-control m-select2-no" id="gender_id" v-model="form.gender_id">
                                        <option value="">{{ __('Choose') }}</option>
                                        <option v-for="(gender, k) in genders" :key="k" :value="gender.id">{{ __(gender.name) }}</option>
                                    </select>
                                    <p class="fs-6 text-danger" v-if="form.errors.gender_id">{{ form.errors.gender_id }}</p>
                                </div>
                                <div class="mb-3 col-12 col-sm-6">
                                    <label class="form-label" for="location_id">{{ __('Location') }}</label>
                                    <select class="form-control m-select2-no" id="location_id" v-model="form.location_id">
                                        <option value="">{{ __('Choose') }}</option>
                                        <option v-for="(location, k) in locations" :key="k" :value="location.id">{{ __(location.name) }}</option>
                                    </select>
                                    <p class="fs-6 text-danger" v-if="form.errors.location_id">{{ form.errors.location_id }}</p>
                                </div>
                            </div>
                            <!-- Gender & Location -->
                            ...
                            <div class="row">
                                <div class="mb-3 col-12">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" type="text" id="map_link" v-model="form.map_link" :placeholder="__('Map link')" />
                                    </div>
                            ...
                            <template v-if="form.cost != 0">
                                <div class="row">
                                    <div class="mb-3 col-12 col-sm-6">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control" type="number" id="price" v-model="form.price" :placeholder="__('Training price')" />
                                        </div>
                            ...
                            <div class="row">
                                <div class="mb-3 col-12">
                                    ...
                                    <span class="fs-6 text-danger" v-if="form.errors.images">{{ form.errors.images }}</span>
                                </div>
                            </div>
                            <!-- images -->
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-12 col-sm-6">
                                    ...
                                    <select class="form-control m-select2-no" id="questionnaire_id" v-model="form.questionnaire_id">
                                        <option value="">{{ __('Choose') }}</option>
                                        <option v-for="(questionnaire, k) in questionnaires" :key="k" :value="questionnaire.id">{{ __(questionnaire.name) }}</option>
                                    </select>
