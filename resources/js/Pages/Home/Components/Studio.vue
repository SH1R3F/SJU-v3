            ...
            <div class="row mt-3">
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a
                            class="nav-link"
                            :class="{ active: route()?.params?.photos }"
                            id="pills-photos-tab"
                            data-toggle="pill"
                            href="#pills-photos"
                            role="tab"
                    ...
                    <li class="nav-item">
                        <a
                            class="nav-link"
                            :class="{ active: route()?.params?.videos }"
                            id="pills-videos-tab"
                            data-toggle="pill"
                            href="#pills-videos"
                            role="tab"
                        ...
                        <div class="row mt-3">
                            <template v-for="item in media.data">
                                <div class="col-md-4 mb-3" v-if="item.type == 'photo'">
                                    <div class="post img-popup" :style="`background: linear-gradient(to bottom, transparent, rgba(0, 0, 0, 0.7)), url('${item.path}')`" :src="item.path">
                                        <div class="category">
                                            <span>{{ __('Photo') }}</span>
                                        </div>
                                    </div>
